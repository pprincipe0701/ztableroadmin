		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tablero",
									"targetURL": "#nebulacomztablero-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomztablero-display": {
								"semanticObject": "nebulacomztablero",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.ztablero",
									"url": sap.ui.require.toUrl("nebula/com/ztablero")
								}
							}
						}
					}
