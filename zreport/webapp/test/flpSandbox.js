		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nebulacomzreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomzreport-display": {
								"semanticObject": "nebulacomzreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.zreport",
									"url": sap.ui.require.toUrl("nebula/com/zreport")
								}
							}
						}
					}
